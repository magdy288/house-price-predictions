...
if __name__ == '__main__':
    input_data_path = './data/raw/house_data.csv'
    output_data_path = './data/processed/featured_house_data.csv'
    processor_path = './models/trained/processor_data.pkl'
    
    run_feature_engineering(input_data_path, output_data_path, processor_path)